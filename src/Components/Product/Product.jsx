      ...
      <div className="w-full p-3 shadow-card dark:shadow-darkCard relative overflow-hidden group rounded-lg">
        ...
        <div className="flex">
          <button
            ...
            } w-full  py-2 mr-2 rounded-lg text-white relative opacity-100 translate-y-0 transition-all sm:opacity-0 sm:translate-y-full sm:transition-all group-hover:opacity-100 group-hover:translate-y-0  group-hover:ease-in-out  group-hover:bottom-0 bg-main  group-hover:duration-200 hover:bg-blue-700 hover:duration-100`}
          >
            Add to Cart
            {isAddingToCart && (
