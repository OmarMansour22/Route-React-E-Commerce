...
export default function ProductDetails() {
  ...
  function getRelatedProduct() {
    return axios
      .get(
        "https://ecommerce.routemisr.com/api/v1/products?limit=7&category[in]=" +
          categoryId
      )
      .then((response) => response.data.data);
  }
  ...
  let {
    ...
    refetch: refetchGetRelatedProduct,
  } = useQuery("relatedProduct", getRelatedProduct, {
    refetchInterval: 60000,
  });
  ...
  useEffect(() => {
    if (favouriteData) {
      ...
      setIsFavourite(
        new Set(favouriteData?.map((fav) => fav._id) || [])?.has(id)
      );
    }
  }, [favouriteData]);
      ...
      <div className="">
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-12 md:col-start-6 md:col-span-7">
            ...
            <div className="mb-4">
              {response?.priceAfterDiscount == undefined ? (
                ...
                <>
                  <span className="text-2xl font-bold mr-2">
                    {response?.priceAfterDiscount} EGP
                  </span>
            ...
            <div className="mt-12">
              <p className="text-main text-3xl my-6">
              ...
              <div className="flex space-x-4 mb-6 mt-50">
                <button
                  ...
                  className={`${
                    isAddingToCart ? "cursor-auto" : "cursor-pointer"
                  } bg-main flex gap-2 items-center text-white px-24 py-3 rounded-md hover:duration-200 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-offset-2`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <button
                  ...
                  className={`hover:text-yellow-400 hover:transition-all hover:duration-200 cursor-pointer ${
